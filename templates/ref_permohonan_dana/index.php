...
$nama_List = "Permohonan Dana";
$main_query= "";
$nama_table = "ref_pd";
$primary_id = "pd_id";
$form_map = " / Financial / Permohonan Dana";
$form_new_title = "Form Add Permohonan Dana";
$form_edit_title = "Form Edit Permohonan Dana";
...
$field_alias_name = "Permohonan Dana No.,";
...
$field_type_name = "pd_no|text-readonly|50^0";
...
$record_show = "pd_no|Nomor|center|sort_on|link_on|sub_query_off~";
...
$child_enable_2 	= "yes";
$child_name_2 		= "Biaya Kegiatan";
$child_main_query_2 = "";
$nama_table_child_2 = "ref_pd_biaya";
$primary_id_child_2 = "pd_biaya_id";
$field_name_child_2 = "ppd_tipe_biaya_id,uraian_biaya,qty,unit_qty_id,price";
$field_type_child_2	= "ppd_tipe_biaya_id|select|select ppd_tipe_biaya_id as id, name as name from master_ppd_tipe_biaya where is_deleted=0^2|Tipe Biaya";
$field_type_child_2	= $field_type_child_2 . "#uraian_biaya|text|50^5|Uraian Biaya";
$field_type_child_2	= $field_type_child_2 . "#qty|text|50^1|Qty";
$field_type_child_2	= $field_type_child_2 . "#unit_qty_id|select|select unit_qty_id as id, name as name from master_unit_qty where is_deleted=0^1|Unit";
$field_type_child_2	= $field_type_child_2 . "#price|text|50^2|Harga Satuan";

$field_child_require_2 	= "ppd_tipe_biaya_id,uraian_biaya,qty,unit_qty_id,price";
$record_show_child_2 	= "ppd_tipe_biaya_id|Tipe Biaya|left|sort_off|select ppd_tipe_biaya_id as id, name as name from master_ppd_tipe_biaya~";
$record_show_child_2 	= $record_show_child_2 . "uraian_biaya|Uraian Biaya|left|sort_off|sub_query_off~";
$record_show_child_2 	= $record_show_child_2 . "qty|Qty|left|sort_off|number~";
$record_show_child_2 	= $record_show_child_2 . "unit_qty_id|Unit|left|sort_off|select unit_qty_id as id, name as name from master_unit_qty~";
$record_show_child_2 	= $record_show_child_2 . "price|Harga Satuan|right|sort_off|decimal~";
