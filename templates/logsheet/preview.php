...
<div class="container">
  <div class="text-left mb-3 pull-right">
      <form name="frmxls" method="POST" class="d-inline-block" action="<?$ANOM_VARS["www_url"]?>templates/logsheet/preview-excel.php?group_location_id=<?=uriParam('group_location_id')?>&unit_id=<?=uriParam('unit_id')?>&date=<?=uriParam('date')?>">
        <label class="control-label" >&nbsp;</label>
        <input type="hidden" name="submit_data">
        <button class="btn btn-success" type="button" onclick="document.frmxls.submit();"> <i class="fa fa-file-excel-o"></i> Export excel</button>
      </form>

      <button onclick="printContent('printArea')" type="button" class="btn btn-secondary"><i class="fa fa-print"></i> Print this page</button>
  </div>
              ...
              <thead>
                <tr>
                  <td style="vertical-align : middle;text-align:center;" rowspan="4" colspan="2">
                    <img src="<?=$ANOM_VARS["www_file_url"]?>upload_photo/<?=$show_unit->row('image')?>" style="width: 100px;">
                  </td>
                  ...
                  <td style="vertical-align : middle;text-align:center;" rowspan="4" colspan="3"><img src="<?=$ANOM_VARS["www_file_url"]?>upload_files/logo-pln.jpg"></td>
                  <!-- <td rowspan="4">&nbsp;</td> -->
                ...
                <tr>
                  ...
                  <td colspan="20">
                    ...
                    <!-- <a class="btn btn-success btn-xs" data-toggle="modal" href="#responsive"><i class="icon-pencil"></i></a> -->
                </td>
              </tr>
              <tr>
