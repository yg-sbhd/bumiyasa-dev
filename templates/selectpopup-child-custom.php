...
function _pilih(x,y,z,namaform,opt1,opt1_val,opt2,opt2_val,opt3,opt3_val)
{
	...
	if (namaform === "newformchild") {
		...
		//opener.document.newformchild.lokasi_barang.value=val_lokasi;
		//opener.document.newformchild.harga_satuan.value=val_hargabrg;
			//alert('okk')
		...
		//opener.document.updatechildform2.lokasi_barang.value=val_lokasi;
		//opener.document.updatechildform2.harga_satuan.value=val_hargabrg;
			//alert('false')
		        ...
		        <tr class="odd gradeX">
			      <td align=right><font size=-2>
					...
					$nama_form = listFirst(uriParam('fname'), '.');
			      	...
			      	// }
					?>			      	
					<a href="javascript:_pilih(
						'<?=$admin->row($primary_id)?>',
						'<?=$admin->row($primary_text)?>',
						'<?=$admin->row($sub_primary_text)?>',
						'<?=$nama_form?>',
						'<?=$opt_1?>',
						'<?=$admin->row($opt_1)?>',
						'<?=$opt_2?>',
