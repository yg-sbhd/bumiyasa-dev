	...
	<div class="col-md-12">
	   ...
	   <div class="portlet">
		 ...
		 <div class="portlet-body">
			<div align="left">
                		<a class="btn default" href="?tmp=<?=encryptStringArray('templates/ref_groupauth/index.php')?>&ref=<?=md5(date("mdyHis"))?>"><< Back</a>
			</div></BR>
			<table class="table table-striped table-bordered table-hover standar-font" id="sample_1">
				...
				while($auth->next()){?>
					   <tr class="odd gradeX">
						  <td align=left><?=$no;?>.</td>
						  <td><font color="green"><h3> - <?=$auth->row("auth_name")?></h3></font></td>
						  <td align="center">
					   ...
					   ?>
						  ...
						  <td><font color="blue"><h4> - - <?=$subauth->row("auth_name")?></h4></font></td>
						  <td align="center">
						  ...
						  $subauth2->query("select * from ref_authorization where parent_id=".$subauth->row("auth_id")." order by auth_id asc");
						   ...
						   ?>
							  ...
							  <td><font size="-1" color="red"><h5> - - - <?=$subauth2->row("auth_name")?></h5></font></td>
							  <td align="center">
						  ...
						  $subauth3->query("select * from ref_authorization where parent_id=".$subauth2->row("auth_id")." order by auth_id asc");
						   ...
						   ?>
							  ...
							  <td><font size="-1" ><h6> - - - - <?=$subauth3->row("auth_name")?></h6></font></td>
							  <td align="center">
							...
							<?
							  ...
							  $subauth4->query("select * from ref_authorization where parent_id=".$subauth3->row("auth_id")." order by auth_id asc");
							   ...
							   ?>
								  ...
								  <td><font size="-1" ><h6> - - - - - - [ <?=$subauth4->row("auth_name")?> ]</h6></font></td>
								  <td align="center">
